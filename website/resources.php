...
<h3>Five-Minute Quickstart Guide</h3>
<p>This is the place to start if you're the impatient type. The five minute
  quickstart guide leads you through the easy steps of downloading and
  submitting a simple working entry. After completing the guide, you should
  be able to see your name on the global leaderboard.
  <a href="quickstart.php">Read More &raquo;</a></p>
...
<p>Have you written an article that you would like to share with the
  ...
  strategy. We will link to it right here on the webpage!</p>
