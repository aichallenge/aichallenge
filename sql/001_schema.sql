...
CREATE TABLE `ranking` (
  ...
  KEY `leaderboard_id_2` (`leaderboard_id`,`submission_id`,`order`)
);
...
INSERT INTO `language` VALUES (0,'Unknown','','',0),
(1,'Java','MyBot.java','java -jar MyBot.jar',0),
(3,'C++','MyBot.cc','./MyBot',1),
(4,'C','MyBot.c','./MyBot',1),
(6,'Python','MyBot.py','python MyBot.py',0),
(7,'C#','MyBot.cs','mono MyBot.exe',0),
(8,'Haskell','MyBot.hs','./MyBot',1),
(9,'Ruby','MyBot.rb','ruby MyBot.rb',0),
(10,'Javascript','MyBot.js','node MyBot.js',0),
(11,'PHP','MyBot.php','php MyBot.php',0),
(12,'Perl','MyBot.pl','perl MyBot.pl',0),
(13,'OCaml','MyBot.ml','./MyBot.native',1),
(14,'CoffeeScript','MyBot.coffee','coffee MyBot.coffee',0),
(15,'Lisp','MyBot.lisp','./MyBot',1),
(17,'Go','MyBot.go','./MyBot',1),
(18,'Groovy','MyBot.groovy','java -cp MyBot.jar:/usr/share/groovy/embeddable/groovy-all-1.7.5.jar MyBot',0);
UNLOCK TABLES;
